...
namespace CampusConnect.Migrations
{
    ...
    [Migration("20251211074742_passwords")]
            ...
            modelBuilder.Entity("CampusConnect.Models.RSVP", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RSVPId = "r1",
                            EventId = "e1",
                            Timestamp = new DateTime(2025, 12, 11, 2, 47, 42, 625, DateTimeKind.Local).AddTicks(3741),
                            UserId = "u1"
                        },
                        new
                        {
                            RSVPId = "r2",
                            EventId = "e2",
                            Timestamp = new DateTime(2025, 12, 11, 2, 47, 42, 625, DateTimeKind.Local).AddTicks(3746),
                            UserId = "u1"
                        });
                });
